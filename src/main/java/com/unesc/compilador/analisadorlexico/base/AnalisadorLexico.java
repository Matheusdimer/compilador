...
import com.unesc.compilador.analisadorlexico.analisador.AnalisadorTokenSimples;
...
public class AnalisadorLexico {
    ...
    public AnalisadorLexico() {
        ...
        analisadores.add(new AnalisadorTokenSimples());
    }
        ...
        while (controller.hasNext()) {
            ...
            for (AbstractAnalisadorExpressao analisador : analisadores) {
                if (analisador.matchRegex(next)) {
                    ...
                    tokens.add(analisador.analisar(controller));
                    break;
                }
            }
        }
