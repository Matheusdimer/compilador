package com.unesc.compilador.analisadorsintatico; /*Coloque o nome do pacote aqui*/;

public class GramaticaCerta implements IGramatica {

	int tabParsing[][] = new int[82][54];

	//inicializar as produ��es
	int producoes[][] = {
